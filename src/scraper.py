...
class Scraper(threading.Thread):
    ...
    def run(self):
        ...
        # ⚡ Bolt: Initialize requests.Session for HTTP Keep-Alive and connection pooling.
        # This significantly reduces network latency by reusing TCP/TLS connections to the same host.
    ...
    def crawl(self):
        ...
        while self.queue and not self.stop_event.is_set():
            ...
            try:
                # Fetch page
                # ⚡ Bolt: Using self.session instead of requests.get to utilize connection pooling
