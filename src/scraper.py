...
class Scraper(threading.Thread):
    def __init__(self, start_url, max_depth, extensions, db_name='files.db'):
        ...
        # Performance optimization: precompute start_url netloc to avoid repeated urlparse calls in loops
        self.start_url_netloc = urlparse(start_url).netloc
            ...
            try:
                ...
                for link in links:
                    ...
                    if is_target:
                        ...
                        if depth < self.max_depth:
                            # Performance optimization: use precomputed netloc instead of calling urlparse on start_url repeatedly
                            if parsed_full.netloc == self.start_url_netloc:
