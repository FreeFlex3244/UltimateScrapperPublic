...
class Scraper(threading.Thread):
    ...
    def crawl(self):
        ...
        while self.queue and not self.stop_event.is_set():
            ...
            try:
                # Fetch page
                # Use session.get() to enable connection pooling.
                # Reusing TCP connections significantly reduces the overhead of establishing a new connection for each request, especially when scraping the same host.
