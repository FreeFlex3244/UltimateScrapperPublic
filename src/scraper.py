...
class Scraper(threading.Thread):
    ...
    def run(self):
        ...
        # Initialize requests Session for connection pooling (Bolt optimization)
        # Reuses TCP connections and reduces TLS handshake overhead
    ...
    def crawl(self):
        ...
        while self.queue and not self.stop_event.is_set():
            ...
            try:
                # Fetch page using session to reuse connection
