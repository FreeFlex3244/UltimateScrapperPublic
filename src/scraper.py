...
class Scraper(threading.Thread):
    ...
    def run(self):
        ...
        # ⚡ Bolt Optimization: Use requests.Session for connection pooling
        # This reuses TCP connections, reducing overhead (DNS, TCP/TLS handshake) for multiple requests to the same domain.
