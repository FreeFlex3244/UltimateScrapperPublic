...
class Scraper(threading.Thread):
    ...
    def crawl(self):
        ...
        while self.queue and not self.stop_event.is_set():
            ...
            try:
                # Fetch page with allow_redirects=False to prevent SSRF via redirect chain
                ...
                if response.status_code in (301, 302, 303, 307, 308):
                    ...
                    if location:
                        ...
                        # Validate redirect destination to prevent SSRF
                        if is_safe_url(redirect_url) and redirect_count < 5:
