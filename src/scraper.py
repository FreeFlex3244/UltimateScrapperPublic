...
class Scraper(threading.Thread):
    ...
    def run(self):
        ...
        # Bolt: Initialize a session for connection pooling to improve performance
        # Reusing connections saves TCP handshake overhead on every request
        ...
        try:
            ...
            self.db.close()
            self.session.close()  # Clean up sockets
    ...
    def crawl(self):
        ...
        while self.queue and not self.stop_event.is_set():
            ...
            try:
                # Fetch page using connection pooling (self.session)
