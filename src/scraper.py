...
class Scraper(threading.Thread):
    ...
    def run(self):
        ...
        # Use requests.Session for connection pooling to reuse TCP connections, significantly improving latency.
    ...
    def crawl(self):
        ...
        while self.queue and not self.stop_event.is_set():
            ...
            try:
                # Fetch page (using connection pooling for better performance)
