...
class Scraper(threading.Thread):
    def __init__(self, start_url, max_depth, extensions, db_name='files.db'):
        ...
        # Precompute tuple for fast O(1) C-level path validation (Performance Optimization)
    ...
    def is_target_file(self, url):
        ...
        # Fast C-level tuple matching instead of O(N) Python loop
        if path.endswith(self.extension_tuple):
