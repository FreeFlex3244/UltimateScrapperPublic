...
class Scraper(threading.Thread):
    ...
    def run(self):
        ...
        # Use requests.Session() for connection pooling. This optimization allows
        # reusing TCP connections, significantly speeding up multiple requests
        # to the same domains.
    ...
    def crawl(self):
        ...
        while self.queue and not self.stop_event.is_set():
            ...
            try:
                # Fetch page using the session for connection pooling
