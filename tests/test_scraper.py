...
class TestScraper(unittest.TestCase):
    def setUp(self):
        ...
        # Mock the database connection object and the session object
        # since we bypass run() in tests which normally initializes them
    ...
    def test_stop(self):
        ...
        # So self.session.get should NOT be called
