...
class TestScraper(unittest.TestCase):
    ...
    def test_redirect_handling(self, mock_get):
        # Test that SSRF via redirect to internal IP is prevented
        ...
        # requests.get should only be called once for the start URL, not for the private IP
        mock_get.assert_called_once_with("http://example.com", timeout=10, allow_redirects=False)
